...
export RAMFS_SOURCE="/root/Ramdisks/GT-I9505-CM12"
...
cp -f /root/Hulk-Kernel/arch/arm/configs/0hulk_cm12_defconfig /root/Hulk-Kernel/0hulk_TW_defconfig
...
# 
make 0hulk_cm12_defconfig VARIANT_DEFCONFIG=jf_eur_defconfig SELINUX_DEFCONFIG=selinux_defconfig SELINUX_LOG_DEFCONFIG=selinux_log_defconfig DEBUG_DEFCONFIG=jfuserdebug_defconfig || exit 1
